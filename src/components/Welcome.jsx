...
//       <div className="flex items-center bg-[#b99470] p-4">
//         <h4 className="font-bold text-xl md:text-2xl text-white">ABG Travels</h4>
//       </div>

//       <section className="flex-grow flex justify-center items-center bg-[#b99470]">
...
//               alt="planet"
//               className="absolute w-full h-full max-w-[100px] max-h-[100px] md:max-w-[250px] md:max-h-[250px] top-[10px] left-[10px] md:rounded-full rounded-lg md:opacity-100 opacity-10"
//               whileTap={{ scale: 0.9 }}
//               drag
//               dragElastic={0.2} // Control elasticity of dragging
//               dragConstraints={{ top: -200, bottom: 200, left: -200, right: 200 }} // Allow movement within a broader range
...
//               alt="planet"
//               className="absolute w-full h-full max-w-[100px] max-h-[100px] md:max-w-[250px] md:max-h-[250px] top-[170px] right-[10px] md:rounded-full rounded-lg md:opacity-100 opacity-10"
//               whileTap={{ scale: 0.6 }}
//               drag
//               dragElastic={0.2}
...
//               alt="planet"
//               className="absolute w-full h-full max-w-[100px] max-h-[100px] md:max-w-[250px] md:max-h-[250px] top-[350px] left-[50px] md:rounded-full rounded-lg md:opacity-100 opacity-10"
//               whileTap={{ scale: 0.8 }}
//               drag
//               dragElastic={0.2}
//               dragConstraints={{ top: -200, bottom: 200, left: -200, right: 200 }}
...
//               alt="planet"
//               className="absolute w-full h-full max-w-[100px] max-h-[100px] md:max-w-[250px] md:max-h-[250px] bottom-[100px] right-[75px] md:rounded-full rounded-lg md:opacity-100 opacity-10"
//               whileTap={{ scale: 0.9 }}
//               drag
//               dragElastic={0.2}
//               dragConstraints={{ top: -200, bottom: 200, left: -200, right: 200 }}
...
//       <div className="bg-[#b99470] text-white">
...
//           </div>
//         </div>
//         <div className="text-sm px-4 md:px-16 py-5">
...
//           <h4 className="font-bold text-lg md:text-2xl">ABG Travels</h4>
...
//           </div>
//         </div>
//         <div className=' z-10 text-black font-bold'>
//         <div className="flex flex-col md:flex-row justify-center md:justify-between items-center px-4 md:px-16 py-5 gap-5">
//           <div className="flex gap-2 md:gap-4">
//             <p>Terms of Use |</p>
//             <p>Contact Us |</p>
